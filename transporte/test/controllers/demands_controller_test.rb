...
class DemandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demand" do
    assert_difference('Demand.count') do
      post demands_url, params: { demand: { category: @demand.category, comment: @demand.comment, plate: @demand.plate, score: @demand.score } }
    end
  ...
  test "should update demand" do
    patch demand_url(@demand), params: { demand: { category: @demand.category, comment: @demand.comment, plate: @demand.plate, score: @demand.score } }
